...
$database = new DB();
	...
	$depedentes = "SELECT dependentes.*, parentesco.nome AS nomeparentesco,
	...
	WHERE referencia='".$_GET['id']."' ORDER by parentesco ASC";
	$resultados_depedentes = $database->get_results($depedentes);
		            ...
		            <div class="col-md-12">
						...
						<div class="row">
							<div class="col">
						  		...
						  		<div class="form-check">
		                            <input class="form-check-input" type="radio" name="falecido_check" id="titular<?php echo $_GET['id'];?>" value="<?php echo $_GET['id'];?>.0">
							...
							<div class="col">
								<div class="form-check">
		                            <input class="form-check-input" type="radio" name="falecido_check" id="dependente<?php echo $key;?>" value="<?php echo $_GET['id'];?>.<?php echo $value['id'];?>">
						...
						<div class="row">
							<div class="col-md-12 text-right">
		                		<button class="btn btn-primary nextBtn btn-lg" type="button" >Próximo</button>
		                	</div>
		                </div>
